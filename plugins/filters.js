...
const array = ['Mm','Hi','power','sad','anthas','failed','alla','chunk','marichu','think','cheyalle','mention','mama','set','eda','umma','police','aysheri','vannu','love','manasilla','uyir','oombi','Mm','important','sed','chathu','girl','poweresh','ooo','bye','pedicho','number','ok','pwoli','chiri','vibe','shut','saved','mood','shaad','pidi','song']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
...
await message.client.sendMessage(message.jid, fs.readFileSync('./videos/mention.mp4'), MessageType.videos, { mimetype: Mimetype.mp4, quoted : message.data, ptt: false})
...
if(pattern.test(message.message)){
   ...
   await message.client.sendMessage(message.jid, fs.readFileSync('./videos/' + a + '.mp4'), MessageType.videos, { mimetype: Mimetype.mp4, quoted: message.data, ptt: false})
...
await message.client.sendMessage(message.jid, fs.readFileSync('./videos/mention.mp4'), MessageType.video, { mimetype: Mimetype.mp4, quoted : message.data, ptt: false})
...
if(pattern.test(message.message)){
   ...
   await message.client.sendMessage(message.jid, fs.readFileSync('./videos/' + a + '.mp4'), MessageType.video, { mimetype: Mimetype.mp4, quoted: message.data, ptt: false})
